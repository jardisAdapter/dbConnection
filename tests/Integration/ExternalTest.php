...
final class ExternalTest extends TestCase
{
    ...
    public function testDisconnectDoesNotCloseExternalConnectionWhenNotManaged(): void
    {
        $pdo = $this->createExternalPdo();
        $connection = new External(new ExternalConfig($pdo), manageLifecycle: false);
    ...
    public function testDisconnectClosesConnectionWhenManaged(): void
    {
        $pdo = $this->createExternalPdo();
        $connection = new External(new ExternalConfig($pdo), manageLifecycle: true);
    ...
    public function testReconnectWithDeadConnectionThrowsException(): void
    {
        $pdo = $this->createExternalPdo();
        $config = new ExternalConfig($pdo);
        $connection = new External($config, manageLifecycle: true);

        $connection->disconnect();

        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('External connection cannot be re-established');
